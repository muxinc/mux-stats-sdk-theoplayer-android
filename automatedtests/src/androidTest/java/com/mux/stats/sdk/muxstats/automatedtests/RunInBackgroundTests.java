...
public class RunInBackgroundTests extends TestBase {
    ...
    public void testBackgroundAudioPlayback() {
        try {
            ...
            int pauseEventIndex = networkRequest.getIndexForFirstEvent(PauseEvent.TYPE);
            if ( pauseEventIndex > playingEventIndex ) {
                fail("{Playback was paused when put to background !!! ");
            }
